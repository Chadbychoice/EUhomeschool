  ...
  const runTests = async () => {
    ...
    if (!supabaseUrl || !supabaseKey || supabaseUrl === 'your_supabase_project_url' || supabaseKey === 'your_supabase_anon_key') {
      setTests(prev => ({
        ...
        envVars: { 
          status: 'error', 
          message: supabaseUrl === 'your_supabase_project_url' || supabaseKey === 'your_supabase_anon_key' 
            ? 'Using placeholder values - please update .env with real Supabase credentials'
